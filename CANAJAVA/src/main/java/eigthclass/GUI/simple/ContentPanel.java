...
public class ContentPanel extends JPanel implements ActionListener {
	...
	private void initialize() {
		...
		Border titleBorder = BorderFactory.createTitledBorder(Constants.CONTENTPANEL_TXT);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.runButton) {
			...
			if (text_I.getText().isEmpty() || text_J.getText().isEmpty()) {
				...
				i = Integer.parseInt(text_I.getText());
				j = Integer.parseInt(text_J.getText());
	...
	private void buttonClicked(Integer i, Integer j) {
		System.out.println("I was clicked from ContentPanel with i value: " + i + " j value: " + j);
	}
}
